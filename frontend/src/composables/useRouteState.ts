...
export function useRouteState() {
  ...
  const viewMode = computed<'characters' | 'best-teams' | 'pull-advisor' | 'banner-advisor' | 'profile' | 'admin'>(() => {
    switch (route.name) {
      case 'best-teams':
        return 'best-teams';
      case 'pull-advisor':
  ...
  function setViewMode(
    mode: 'characters' | 'best-teams' | 'pull-advisor' | 'banner-advisor' | 'profile' | 'admin',
