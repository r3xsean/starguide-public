...
const steps: OnboardingStep[] = [
  ...
  },
  {
    ...
    description: 'Right-click characters to mark them as owned (✓) or planning to pull (?). Build a team of at least 4 characters with one DPS to unlock team recommendations!',
    icon: '🎯',
    position: 'right',
  ...
  },
  {
    ...
    description: 'Switch between Teammates (recommended partners), My Teams (auto-generated from your roster), and Pull Advisor (who to wish for next).',
    icon: '◈',
    position: 'bottom',
  },
  {
  ...
  <Teleport to="body">
    <Transition name="overlay-fade">
      <div
        ...
        :class="{
          'allow-interaction': currentStep.waitForInteraction && !canProceed,
              ...
              <div v-if="currentStep.showProgress && currentStep.id === 'roster-builder'" class="roster-progress">
                <div class="progress-item">
                  <span class="progress-count" :class="{ 'complete': ownedCharacters.length >= 4 }">
                    {{ ownedCharacters.length }}/4
                  </span>
                  <span class="progress-label">Characters</span>
